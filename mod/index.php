	        				...
	        				<div class="row h-100 justify-content-center align-items-center">
	        					<div class="col-lg-5">
	        						<div class="hero-content text-center text-white">
	        							<p>
	        								<img src="<?php echo $site_url; ?>/content/logo/logo_tlkm.jpg" class="img-fluid" width="180px">
	        							</p>
	        							...
	        							<i aria-hidden="true" class="fa fa-check-circle"></i> Powered by geng kangkung
	        						</div>
	        					</div>
	        					<div class="col-lg-6">
	        		...
	        		<div class="row">
	        			...
	        			<div class="col-lg-4 col-md-12">
	        				<div class="single-footer-widget pl-5">
	        					...
	        					<ul class="list">
	        						<li><a href="https://mycoding.id" title="Tentang Kami" alt="Tentang Kami">Tentang Kami</a></li>
	        						<li><a href="<?php echo $site_url; ?>/AbsensiOnline.apk" title="Platform Aplikasi" alt="Platform Aplikasi">Platform Aplikasi</a></li>
	        						<li><a href="https://mycoding.id" title="Dukungan Teknologi" alt="Dukungan Teknologi">Dukungan Teknologi</a></li>
	        						<li><a href="https://mycoding.id" title="Dukungan Pembayaran" alt="Dukungan Pembayaran">Dukungan Pembayaran</a></li>
	        						<li><a href="https://mycoding.id" title="Ketentuan Layanan" alt="Ketentuan Layanan">Ketentuan Layanan</a></li>
	        						<li><a href="https://mycoding.id" title="Pertanyaan Umum" alt="Pertanyaan Umum">Pertanyaan Umum</a></li>
	        					</ul>
	        				</div>
	        			</div>
	        			<div class="col-lg-4 col-md-12">
	        				<div class="single-footer-widget pl-5">
	        					...
	        					<br/>
	        					<ul class="list">
	        						<li><a href="https://401xd.com">Hubungi Kami</a></li>
	        						<li><a href="https://401xd.com">Mitra & Jaringan</a></li>
	        					</ul>
	        				</div>
	        			</div>
	        			<div class="col-lg-12 col-md-12">
	        				<div class="copyright-area">
	        					Copyright ©2020-2021 <a class="text-white" href="https://mycoding.id"> MC Project</a> by <a class="text-white" href="https://401xd.com"> 401XD Group</a>.
	        				</div>
	        			</div>
	        		</div>
	        	</div>
